				...
				editor.addCommand( 'insertToc', {
					...
					exec: function( editor )
					{
						...
						for ( var i = 0 ; i < nodes.count() ; i++ )
						{
							...
							tocItems = tocItems + '<div style="margin-left:'+level*40+'px" id="' + id.toString() + '-toc" name="tableOfContents">' + '<a class="color-a" href="#' + id.toString() + '">' + text.getText().toString() + '</a></div>';
						}

						//output toc
						var tocNode = '<p name="tableOfContents" id="main-toc"><b>Daftar Isi</b></p>' + tocItems + '<hr id="hr-toc" name="tableOfContents"/>';
